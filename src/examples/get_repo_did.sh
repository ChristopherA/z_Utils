...
## Origin:        https://github.com/ChristopherA/z_Utils/blob/main/src/examples/get_repo_did.sh
## DID:           did:repo:b0c5cd0d85b29543c604c093dd83a1a20eb17af1/blob/main/src/examples/get_repo_did.sh
...
core_Logic() {
    ...
    print "did:repo:$(get_First_Commit_Hash "$RepoDir")" || return $Exit_Status_General
    return $Exit_Status_Success
}
